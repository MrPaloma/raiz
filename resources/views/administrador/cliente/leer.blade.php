        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="formclienteistrador.html">Nuevo</a></li>
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <a href="{{route('cliente.create')}}" class="btn btn-lg btn-outline-primary "><i class="fas fa-plus"></i> Agregar Nuevo</a>
              </div>
              <div class="card-body">
                <div id="example1_wrapper" class="dataTables_wrapper dt-bootstrap4 table-responsive">
                  ...
                  <table id="example2" class="table table-bordered table-hover dataTable dtr-inline" role="grid" aria-describedby="example2_info">
                    ...
                    <tr role="row">
                      ...
                      <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="CSS grade: activate to sort column ascending">Subir Doc's</th>
                    ...
                    <tr><th rowspan="1" colspan="1">ID</th>
                      ...
                      <th rowspan="1" colspan="1">Subir Doc's</th>
